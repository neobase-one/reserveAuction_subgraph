...
export class ReserveAuctionFindersErc20__auctionForNFTResult {
  value0: Address;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class ReserveAuctionFindersErc20 extends ethereum.SmartContract {
  static bind(address: Address): ReserveAuctionFindersErc20 {
    return new ReserveAuctionFindersErc20(
  ...
  auctionForNFT(
    param0: Address,
    param1: BigInt
  ): ReserveAuctionFindersErc20__auctionForNFTResult {
    let result = super.call(
      "auctionForNFT",
      "auctionForNFT(address,uint256):(address,address,uint256,uint256,address,uint96,address,uint96,address,uint80,uint16)",
      [
    ...
    return new ReserveAuctionFindersErc20__auctionForNFTResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_auctionForNFT(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<ReserveAuctionFindersErc20__auctionForNFTResult> {
    ...
    return ethereum.CallResult.fromValue(
      new ReserveAuctionFindersErc20__auctionForNFTResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
