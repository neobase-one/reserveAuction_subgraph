...
export class ReserveAuctionFindersEth__auctionForNFTResult {
  value0: Address;
  value1: BigInt;
  value2: Address;
  value3: BigInt;
...
export class ReserveAuctionFindersEth extends ethereum.SmartContract {
  static bind(address: Address): ReserveAuctionFindersEth {
    return new ReserveAuctionFindersEth("ReserveAuctionFindersEth", address);
  }

  auctionForNFT(
    param0: Address,
    param1: BigInt
  ): ReserveAuctionFindersEth__auctionForNFTResult {
    ...
    return new ReserveAuctionFindersEth__auctionForNFTResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_auctionForNFT(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<ReserveAuctionFindersEth__auctionForNFTResult> {
    ...
    return ethereum.CallResult.fromValue(
      new ReserveAuctionFindersEth__auctionForNFTResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toAddress(),
        value[3].toBigInt(),
