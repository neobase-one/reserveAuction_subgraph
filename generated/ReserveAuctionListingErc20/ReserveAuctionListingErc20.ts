...
export class ReserveAuctionListingErc20__auctionForNFTResult {
  value0: Address;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class ReserveAuctionListingErc20 extends ethereum.SmartContract {
  static bind(address: Address): ReserveAuctionListingErc20 {
    return new ReserveAuctionListingErc20(
  ...
  auctionForNFT(
    param0: Address,
    param1: BigInt
  ): ReserveAuctionListingErc20__auctionForNFTResult {
    ...
    return new ReserveAuctionListingErc20__auctionForNFTResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_auctionForNFT(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<ReserveAuctionListingErc20__auctionForNFTResult> {
    ...
    return ethereum.CallResult.fromValue(
      new ReserveAuctionListingErc20__auctionForNFTResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
