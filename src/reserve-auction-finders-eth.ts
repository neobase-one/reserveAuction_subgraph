import {
  AuctionBidAuctionStruct as AuctionFinderETH,
...
import { fetchAuctionBid, fetchAuctionEvent, fetchAuctionFinderETH } from "./utils/reserve-auction.utils"

export function handleAuctionBid(event: AuctionBidEvent): void {
  let entity = fetchAuctionFinderETH(true, "FINDER_ETH", event.params.tokenContract, event.params.tokenId, changetype<AuctionFinderETH>(event.params.auction))
  entity.save()
...
export function handleAuctionCanceled(event: AuctionCanceledEvent): void {
  let entity = fetchAuctionFinderETH(false, "FINDER_ETH", event.params.tokenContract, event.params.tokenId, changetype<AuctionFinderETH>(event.params.auction))
  entity.save()
